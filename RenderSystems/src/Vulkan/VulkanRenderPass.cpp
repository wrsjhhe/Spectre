...
void VulkanRenderPass::CreateRenderPass(const std::vector<VkAttachmentDescription>& attachments, const VkSubpassDescription& subpassDescription, const std::vector<VkSubpassDependency>& dependencies)
{
